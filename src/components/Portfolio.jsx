...
import portfolio5 from "../assets/plan-contreBas-coiffure-bordeaux-préparation.jpg";
import portfolio6 from "../assets/plan-contreBas-coiffure-bordeaux-préparation.jpg";
import portfolio7 from "../assets/plan-contreBas-coiffure-bordeaux-préparation.jpg";
import portfolio8 from "../assets/salon-rincage-shampoing.jpg";
import portfolio9 from "../assets/salon-rincage-shampoing.jpg";
import portfolio10 from "../assets/cheveux-roses-décoiffé.webp";
...
function Portfolio() {
  ...
  return (
  <Section id="galerie" ref={element}>
    <div className="grid">
